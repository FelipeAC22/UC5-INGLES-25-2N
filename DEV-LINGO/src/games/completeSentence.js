...
export function completeSentence() {
    ...
    const sentences = [
        ...
        {
            text: "He ____ to the gym every day.",
            answer: "goes"
        },
        {
            text: "We ____ like coffee.",
            answer: "don't"
        },
        {
            text: "The cat ____ sleeping on the sofa.",
            answer: "is"
        },
        {
            text: "____ you speak English?",
            answer: "Do"
        },
        {
            text: "It ____ a very sunny day.",
            answer: "is"
        },
        {
