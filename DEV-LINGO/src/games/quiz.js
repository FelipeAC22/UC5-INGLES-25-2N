...
export function quiz() {
    ...
    const questions = [
        ...
        {
            question: "The cat ____ black.",
            options: ["1) are", "2) am", "3) is"],
            answer: "3"
        },
        {
            question: "You ____ a great teacher.",
            options: ["1) is", "2) are", "3) am"],
            answer: "2"
        },
        {
        ...
        {
            question: "Dogs ____ loyal animals.",
            options: ["1) is", "2) am", "3) are"],
            answer: "3"
        },
        {
            question: "The movie ____ very long.",
            options: ["1) is", "2) are", "3) am"],
            answer: "1"
        },
        {
        ...
        {
            question: "Pizza ____ my favorite food.",
            options: ["1) is", "2) are", "3) am"],
            answer: "1"
        }
    ]
