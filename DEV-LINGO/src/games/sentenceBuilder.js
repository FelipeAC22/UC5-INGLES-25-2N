...
export function sentenceBuilder() {
    ...
    let challenge = [
        ...
        {
            words: ["love", "I", "coding"],
            correct: "I love coding"
        },
        {
            words: ["is", "blue", "The", "sky"],
            correct: "The sky is blue"
        },
        {
            words: ["tea", "drink", "They", "hot"],
            correct: "They drink hot tea"
        },
        {
            words: ["fast", "car", "runs", "The"],
            correct: "The car runs fast"
        },
        {
            words: ["English", "learning", "We", "are"],
            correct: "We are learning English"
        },
        {
            words: ["book", "read", "a", "Please"],
            correct: "Please read a book"
        },
        {
            words: ["pizza", "like", "not", "do", "I"],
            correct: "I do not like pizza"
        },
        {
            words: ["beautiful", "is", "city", "The"],
